            ...
            <Row gutter={16}>
              ...
              <Col lg={12} md={12} sm={24}>
                <FormItem {...formItemLayout} label='编号'>
                  <Input
                    disabled
                    value={(isNotBlank(cpStayFormGet) && isNotBlank(cpStayFormGet.user) ? cpStayFormGet.user.no : '')}
                  />
                </FormItem>
              </Col>
              <Col lg={12} md={12} sm={24}>
              ...
              <Col lg={12} md={12} sm={24}>
                <FormItem {...formItemLayout} label='所属部门'>
                  <Input
                    disabled
                    value={(isNotBlank(cpStayFormGet) && isNotBlank(cpStayFormGet.user) && isNotBlank(cpStayFormGet.user.dept)? cpStayFormGet.user.dept.name : '')}
                  />
                </FormItem>
              </Col>
            </Row>
            ...
            <Row gutter={16}>
              <Col lg={12} md={12} sm={24}>
                <FormItem {...formItemLayout} label='客户'>
                  <Input
                    ...
                    disabled
                    value={(isNotBlank(cpStayFormGet) && isNotBlank(cpStayFormGet.client)&& isNotBlank(cpStayFormGet.client.clientCpmpany) ? cpStayFormGet.client.clientCpmpany : '')}
                  />
                </FormItem>
              </Col>
              <Col lg={12} md={12} sm={24}>
              ...
              <Col lg={12} md={12} sm={24}>
                <FormItem {...formItemLayout} label='客户编号'>
                  <Input
                    disabled
                    value={(isNotBlank(cpStayFormGet) && isNotBlank(cpStayFormGet.client) ? cpStayFormGet.client.code : '')}
                  />
                </FormItem>
              </Col>
              <Col lg={12} md={12} sm={24}>
              ...
              <Col lg={12} md={12} sm={24}>
                <FormItem {...formItemLayout} label='订单状态'>
                  {getFieldDecorator('orderStatus', {
                    initialValue: isNotBlank(cpStayFormGet) && isNotBlank(cpStayFormGet.orderStatus) ? cpStayFormGet.orderStatus == 1 ? "已处理" : "未处理" : '',     
                    rules: [
                      {
                        required: true,   
                        message: '请输入订单状态',
                  ...
                  })(<Input  style={isNotBlank(cpStayFormGet) && cpStayFormGet.orderStatus ==1 ? {color:"green"}:{color:"red"}} />)}
                </FormItem>
              </Col>
