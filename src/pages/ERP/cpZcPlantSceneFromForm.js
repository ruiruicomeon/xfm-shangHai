            ...
            <Card title="基本信息" bordered={false}> 
              <Row>
                ...
                <Col lg={24} md={24} sm={24}>
                  <FormItem {...formItemLayout} label='订单单号' className="allimgstyle">
                ...
                <Col lg={12} md={12} sm={24}>
                  <FormItem {...formItemLayout} label='总成仓库'>
                    <Input disabled value={isNotBlank(cpPlantSceneFromGet) && isNotBlank(cpPlantSceneFromGet.cpEntrepot) && isNotBlank(cpPlantSceneFromGet.cpEntrepot.name)? cpPlantSceneFromGet.cpEntrepot.name : ''} />
                  </FormItem>
                </Col>
                <Col lg={12} md={12} sm={24}>
                  <FormItem {...formItemLayout} label='总成库位'>
                    <Input disabled value={isNotBlank(cpPlantSceneFromGet) && isNotBlank(cpPlantSceneFromGet.cpStorage) && isNotBlank(cpPlantSceneFromGet.cpStorage.name)? cpPlantSceneFromGet.cpStorage.name : ''} />
                  </FormItem>
                </Col>
                <Col lg={12} md={12} sm={24}>
                  <FormItem {...formItemLayout} label='总成型号'>
                    {getFieldDecorator('assemblyModel', {
										initialValue: isNotBlank(cpPlantSceneFromGet) && isNotBlank(cpPlantSceneFromGet.assemblyBuild)  && isNotBlank(cpPlantSceneFromGet.assemblyBuild.assemblyModel) ? cpPlantSceneFromGet.assemblyBuild.assemblyModel : '',     
										rules: [
											{
												required: false,   
												message: '请输入总成型号',
                ...
                <Col lg={12} md={12} sm={24}>
                  <FormItem {...formItemLayout} label='品牌'>
                    {getFieldDecorator('assemblyBrand', {
										initialValue: isNotBlank(cpPlantSceneFromGet) && isNotBlank(cpPlantSceneFromGet.assemblyBuild)  && isNotBlank(cpPlantSceneFromGet.assemblyBuild.assemblyBrand) ? cpPlantSceneFromGet.assemblyBuild.assemblyBrand : '',     
										rules: [
											{
												required: false,   
												message: '请输入品牌',
                ...
                <Col lg={12} md={12} sm={24}>
                  <FormItem {...formItemLayout} label='车型/排量'>
                    {getFieldDecorator('assemblyVehicleEmissions', {
										initialValue: isNotBlank(cpPlantSceneFromGet) && isNotBlank(cpPlantSceneFromGet.assemblyBuild)  && isNotBlank(cpPlantSceneFromGet.assemblyBuild.vehicleModel)  ? cpPlantSceneFromGet.assemblyBuild.vehicleModel : '',     
										rules: [
											{
												required: false,   
												message: '请输入车型/排量',
                ...
                <Col lg={12} md={12} sm={24}>
                  <FormItem {...formItemLayout} label='年份'>
                    {getFieldDecorator('assemblyYear', {
										initialValue: isNotBlank(cpPlantSceneFromGet) && isNotBlank(cpPlantSceneFromGet.assemblyBuild)  && isNotBlank(cpPlantSceneFromGet.assemblyBuild.assemblyYear) ? cpPlantSceneFromGet.assemblyBuild.assemblyYear : '',     
										rules: [
											{
												required: false,   
												message: '请输入年份',
                ...
                <Col lg={12} md={12} sm={24}>
                  <FormItem {...formItemLayout} label='出库类型'>
                    <Input disabled  value={isNotBlank(cpPlantSceneFromGet) && isNotBlank(cpPlantSceneFromGet.zcStirageType) ?cpPlantSceneFromGet.zcStirageType: ''} />
                  </FormItem>
                </Col>
                <Col lg={12} md={12} sm={24}>
