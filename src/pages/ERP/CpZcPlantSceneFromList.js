...
class CpPlantSceneFromList extends PureComponent {
  ...
  gotoForm = () => {
    router.push(`/warehouse/process/cp_zc_plantScene_from_form`);
  }

  gotoUpdateForm = (id) => {
    router.push(`/warehouse/process/cp_zc_plantScene_from_form?id=${id}`);
  }
        ...
        <div className={styles.standardList}>
          <Card bordered={false}>
            <div className={styles.tableList}>
              ...
              <div style={{textAlign:'center',fontWeight:550,fontSize:28,marginBottom:'16px'}}>总成车间现场库</div>
