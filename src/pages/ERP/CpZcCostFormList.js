...
class CpCostFormList extends PureComponent {
  ...
  gotoForm = () => {
    router.push(`/warehouse/process/cp_zc_cost_form_form`);
  }

  gotoUpdateForm = (id) => {
    router.push(`/warehouse/process/cp_zc_cost_form_form?id=${id}`);
  }
        ...
        <div className={styles.standardList}>
          <Card bordered={false}>
            <div className={styles.tableList}>
              ...
              <div style={{textAlign:'center',fontWeight:550,fontSize:28,marginBottom:'16px'}}>总成成本单</div>
