...
class CpCloseList extends PureComponent {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'cpstatistics/find_InternalTotalOutPutValue_two',
      payload: {
        pageSize: 10,
        switchType: 3,
        current: 1,
          ...
          <Card bordered={false}>
            <div className={styles.tableList}>
              ...
              <StandardEditTable
                ...
                data={{
                  list:
                    isNotBlank(findTwoInternalTotalOutPutValueGet) &&
                      isNotBlank(findTwoInternalTotalOutPutValueGet.list) &&
                      findTwoInternalTotalOutPutValueGet.list.length > 0
                      ? findTwoInternalTotalOutPutValueGet.list
                      : [],
                  pagination: {
                    total:
                      isNotBlank(findTwoInternalTotalOutPutValueGet) &&
                        isNotBlank(findTwoInternalTotalOutPutValueGet.pagination) &&
                        isNotBlank(findTwoInternalTotalOutPutValueGet.pagination.total)
                        ? findTwoInternalTotalOutPutValueGet.pagination.total
                        : 0,
                    current:
                      isNotBlank(findTwoInternalTotalOutPutValueGet) &&
                        isNotBlank(findTwoInternalTotalOutPutValueGet.pagination.current)
                        ? findTwoInternalTotalOutPutValueGet.pagination.current
                        : 1,
                    pageSize:
                      isNotBlank(findTwoInternalTotalOutPutValueGet) &&
                        isNotBlank(findTwoInternalTotalOutPutValueGet.pagination) &&
                        isNotBlank(findTwoInternalTotalOutPutValueGet.pagination.pageSize)
                        ? findTwoInternalTotalOutPutValueGet.pagination.pageSize
                        : 10,
                  },
                }}
                bordered
