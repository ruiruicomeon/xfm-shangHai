...
@connect(({ cpOutSalesFrom, cpPurchaseDetail, loading }) => ({
  ...cpOutSalesFrom,
  ...cpPurchaseDetail,
  submitting: loading.effects['form/submitRegularForm'],
}))
class madeUp_GoodsReturn extends PureComponent {
  ...
  render() {
    const { cpOutSalesFromGet, cpPurchaseDetailList } = this.props;
    ...
    return (
      <div style={{ color: '#000', paddingLeft: '6mm', paddingRight: '6mm', width: '200mm', boxSizing: 'border-box' }}>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style={{ borderBottom: '1px solid #000000', width: '22%', }}>
                <div>
                  <span>   {isNotBlank(cpOutSalesFromGet) && isNotBlank(cpOutSalesFromGet.parent)
                    ? cpOutSalesFromGet.parent
                    : ''}</span>
                </div>
              </td>
              ...
              <td style={{ borderBottom: '1px solid #000000', width: '22%', }}>
                <div>
                  <span>
                    {isNotBlank(cpOutSalesFromGet) && isNotBlank(cpOutSalesFromGet.orderCode)
                      ? cpOutSalesFromGet.orderCode
                      : ''}
                  </span>
                </div>
              </td>
              ...
              <td style={{ borderBottom: '1px solid #000000' }}>
                <div>
                  <span>{isNotBlank(cpOutSalesFromGet) && isNotBlank(cpOutSalesFromGet.createDate)
                    ? cpOutSalesFromGet.createDate
                    : ''}</span>
                </div>
              </td>
            </tr>
            <tr>
              ...
              <td style={{ borderBottom: '1px solid #000000' }}>
                <div>
                  <span>
                    {isNotBlank(cpOutSalesFromGet) &&
                      isNotBlank(cpOutSalesFromGet.cpSupplier) &&
                      isNotBlank(cpOutSalesFromGet.cpSupplier.name)
                      ? cpOutSalesFromGet.cpSupplier.name
                      : ''}
                  </span>
                </div>
              </td>
              ...
              <td colSpan={3} rowSpan={1} style={{ borderBottom: '1px solid #000000' }}>
                <div>
                  <span>  {isNotBlank(cpOutSalesFromGet) &&
                    isNotBlank(cpOutSalesFromGet.cpSupplier) &&
                    isNotBlank(cpOutSalesFromGet.cpSupplier.address)
                    ? cpOutSalesFromGet.cpSupplier.address
                    : ''}</span>
                </div>
              </td>
            </tr>
            <tr>
              ...
              <td style={{ borderBottom: '1px solid #000000' }}>
                <div>
                  <span>  {isNotBlank(cpOutSalesFromGet) &&
                    isNotBlank(cpOutSalesFromGet.cpSupplier) &&
                    isNotBlank(cpOutSalesFromGet.cpSupplier.linkman)
                    ? cpOutSalesFromGet.cpSupplier.linkman
                    : ''}</span>
                </div>
              </td>
              <td style={{ textAlign: 'right', background: '#cccccc' }}
              ...
              <td style={{ whiteSpace: 'nowrap' }}>
                <div>
                  <span>
                    {isNotBlank(cpOutSalesFromGet) && isNotBlank(cpOutSalesFromGet.cpSupplier) && isNotBlank(cpOutSalesFromGet.cpSupplier.id)
                      ? cpOutSalesFromGet.cpSupplier.id
                      : ''}
                  </span>
                </div>
              </td>
              ...
              <td style={{ borderBottom: '1px solid #000000' }}>
                <div>
                  <span>  {isNotBlank(cpOutSalesFromGet) &&
                    isNotBlank(cpOutSalesFromGet.cpSupplier) &&
                    isNotBlank(cpOutSalesFromGet.cpSupplier.phone)
                    ? cpOutSalesFromGet.cpSupplier.phone
                    : ''}</span>
                </div>
              </td>
            </tr>
        ...
        <div style={{ clear: 'both', height: '15mm', width: '188mm', fontSize: '14px' }}>
          ...
          <span>壹仟叁佰元</span> */}
          &nbsp; &nbsp; 金额：<span>{getPrice(cpOutSalesFromGet.money)}</span>&nbsp; &nbsp; 大写：
          <span>{this.convertCurrency(getPrice(cpOutSalesFromGet.money))}</span>
          <br /> 制单人：<span>{isNotBlank(cpOutSalesFromGet) && isNotBlank(cpOutSalesFromGet.createBy) && isNotBlank(cpOutSalesFromGet.createBy.name)
            ? cpOutSalesFromGet.createBy.name
            : ''}</span>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;经手人： &nbsp; &nbsp; &nbsp; &nbsp;
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
...
export default madeUp_GoodsReturn;
